				...
				new ActionListener(){
					public void actionPerformed(ActionEvent e){
						 ...
						 JOptionPane.showMessageDialog(null,
								    ...
								    "\nDados digitados:"+
							        "\nTipo do Fornecedor: " + campo1.getText()+
							        "\nRazão Social: " + campo2.getText()+
							        "\nNome Fantasia: " + campo3.getText()+
							        "\nCPF/CNPJ: " + campo4.getText()+
							        "\nRepresentante: " + campo5.getText()+
							        "\nEndereço: " + campo6.getText()+
							        "\nBairro: " + campo7.getText()+
							        "\nCidade: " + campo8.getText()+
							        "\nCEP: " + campo9.getText()+
							        "\nE-mail: " + campo10.getText()+
							        "\nFone: " + campo11.getText()+
							        "\nFax: " + campo12.getText()+
							        "\nNIT: " + campo13.getText()+
							        "\nEmite Fatura? " + campo14.getText()
							        

							        //ascaracpf, mascaracep, mascarafone, mascarafax, mascaranit;
								 );
